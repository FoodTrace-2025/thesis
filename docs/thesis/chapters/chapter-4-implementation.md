...
Consumer query interface provides public product verification without authentication or wallet requirements, addressing the 78% blockchain app abandonment rate caused by wallet complexity (Consensys, 2023).
