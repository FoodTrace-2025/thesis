# OAMK Thesis Structure - FoodTrace Project

**Document Type:** OAMK Thesis Structure Reference
...
**Target Length:** 60-65 pages (15-20 pages per person)
...
## ⚠️ LENGTH MANAGEMENT (CRITICAL)

**Target:** 60-65 pages = ~16,500-17,875 words total (at 275 words/page)

### Per-Chapter Word Count Targets

**Use these targets to prevent thesis bloat:**

| Chapter | Target Words | Max Words | Notes |
|---------|--------------|-----------|-------|
| **Ch 1 - Introduction** | 1,000-1,200 | 1,500 | Background + objectives + scope |
| **Ch 2 - Literature Review** | 2,200-2,700 | 3,000 | Synthesize, don't summarize everything |
| **Ch 3 - Methodology** | 1,400-1,700 | 2,000 | Process + justification, not tutorial |
| **Ch 4 - Implementation** | 2,700-3,300 | 4,000 | What you built, key code only |
| **Ch 5 - Testing & Results** | 1,900-2,300 | 2,500 | Results + analysis, detailed tables to appendix |
| **Ch 6 - Discussion** | 1,400-1,700 | 2,000 | Interpret + implications + limitations |
| **Ch 7 - Conclusion** | 1,100-1,300 | 1,500 | Answers + contributions + future work |
| **Abstract + Front Matter** | 500-600 | 800 | Abstract 250-300 words |
| **TOTAL** | **~17,000** | **~19,000** | **DO NOT EXCEED 19,000 WORDS** |

### Length Management Rules

**⚠️ WARNING:** Exceeding word limits demonstrates poor synthesis skills and will impact your grade.

**Best Practices:**
- ✅ **Synthesize, don't summarize** - Compare and contrast sources, don't list them
- ✅ **Move details to appendices** - Full code, detailed tables, raw data
- ✅ **Cut redundancy ruthlessly** - If you've said it once, don't repeat it
- ✅ **One figure = 100 words** - Use visuals to replace text where possible
- ✅ **Focus on "why" not "what"** - Explain decisions, not just describe actions

**Appendix Strategy (Unlimited Length):**
- Appendix A: Complete source code (smart contracts, key components)
- Appendix B: Detailed test results tables
- Appendix C: Additional diagrams and wireframes
- Appendix D: User testing questionnaires and raw data
- Appendix E: Risk assessment matrices

**Remember:** OAMK reviewers prefer **concise and focused** over **comprehensive and bloated**. A 65-page thesis that demonstrates critical thinking will score higher than a 150-page literature dump.
...
- **Voice:** Use **active voice** for clarity and directness (2025 standard)
  - ✅ **PREFERRED**: "We developed the system..." (clear, direct, modern)
  - ❌ **AVOID**: "The system was developed..." (wordy, passive, dated)
  - Exception: Use passive when actor is unknown or irrelevant
...
[Answer structure: Literature support → Our findings → Field positioning → Contradictions acknowledged]

**Q2: What are advantages and limitations compared to traditional systems?**

[Answer structure: Comparative analysis → Cost/benefit trade-offs → Field context → Reconciliation of tensions]

**Q3: How to balance transparency with privacy in blockchain food traceability?**

[Answer structure: Hybrid architecture analysis → Literature dialogue → Implementation validation → Unexplored tensions]

**Q4: What is the feasibility of blockchain traceability for small-scale producers?**

[Answer structure: Economic/technical feasibility → Literature gap → Our positioning → Field impact]
...
[Identify gap from literature, quantify, explain why it matters]

#### 7.3.2 Our Innovation Positioning

[Position your work within the gap - what specific innovations address it]

#### 7.3.3 Impact on Field Development

[Evaluate how your work shifts research frontier, provides implementation path, reconciles contradictions]
...
## Writing Timeline Reference

**For complete weekly breakdown and collaborative session planning, see:**
→ Original `thesis-outline.md` (archived) - Section: "WRITING TIMELINE (Weeks 10-12)"

**Week 10 (Jan 3-9, 2026):**
- Sam: Ch 1 + Ch 2.1-2.2
- TaiSheng: Ch 2.3 + Ch 3
- YiLing: Ch 2.4-2.5 + Ch 4.3
- Team Meeting: Friday review

**Week 11 (Jan 10-16, 2026):**
- Sam: Ch 4.1 + Ch 6
- TaiSheng: Ch 4.2 + Ch 5
- YiLing: Screenshots + Ch 5.3 + Figure formatting
- Team Collaborative: Abstract (Friday evening)

**Week 12 (Jan 17-23, 2026):**
- Monday: Chapter 7 (Conclusion) - collaborative 6-8 hours
- Tuesday-Friday: Compile references, format appendices, full review, final edits
...
**Document Status:**
✅ Structure complete
✅ Page targets defined
✅ Team ownership assigned
📝 Ready for Week 10-12 writing phase

**Last Updated:** November 2025 (Session 7)
**Source:** Extracted from `thesis-outline.md` (archived)
